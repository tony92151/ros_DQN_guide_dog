...
def optimize_model():
    ...
    state_action_values = policy_net(state_batch).gather(1, action_batch) #compute the action after this step as state_action_values
    # print("******pp*******")
...
for i_episode in range(num_episodes):
    ...
    for t in count():
        ...
        _, reward, done, _ = env.step(action.item()) #observation,reward,done,info
